...
export const showLoader = (text = 'Processando...') => {
  dom.loaderText.textContent = translateMessage(text);
...
function translateMessage(text: any): any {
  if (typeof text !== 'string') return text;
  if (alertMessageMap[text]) return alertMessageMap[text];
...
export const showAlert = (title: any, message: any) => {
  ...
  dom.alertMessage.textContent = translateMessage(message);
